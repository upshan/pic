...
public class PathUtil {
    ...
    private static final String IMAGE_ROOT_GENERATED = "/pic";
    ...
    private static final String SIZE_KEY = "jd8m@dc";
    ...
    public static String imgSign(String fileName){
        return DigestUtils.md5Hex(fileName + "_" + SIZE_KEY).substring(24);
    }

...
public class ExtensionInvocationPlugin extends PlayPlugin {
    ...
    public void onApplicationStart() {
        ...
        Logger.info("Module util.Support: " + ExtensionInvocationPlugin.class.getName() + " loaded.");
    ...
    public void onRoutesLoaded() {
        Logger.debug("adding routes for util.Support:" + ExtensionInvocationPlugin.class.getName());
